...
\begin{frame}{Inquadramento dell'area}
\begin{multicols}{2}
Dove ci troviamo? \\
...
\begin{frame}{Considerazioni ambientali} % Il titolo va tra graffe
Clima desertico: 
	\begin{itemize}
...
% Creo un nuovo comando per allargare il margine e farci stare le tre colonne successive
...
\begin{frame}
\smallermargins % uso il comando di prima per ridurre i margini 
...
\restoregeometry % serve per far tornare i margini com'erano prima 
...
\begin{frame}{Risultato}
	\begin{figure}
		\centering
		\includegraphics[width=0.9\linewidth]{2019-2023.png}
