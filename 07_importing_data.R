...
setwd("C:/Users/lucaf/OneDrive/Desktop/UNI/SCIENZE E GESTIONE DELLA NATURA/Primo anno/telerilevamento")
...
# ora andiamo ad importare i dati da copernicus come se fosse quello che abbiamo appena fatto 
soil<- rast("c_gls_SSM1km_202404210000_CEURO_S1CSAR_V1.2.1.nc")
plot(soil)

# posso anche fare una parte dell'immagine, gli dico quale x e y metterre.
ext <- c(25,30,55,58) #sono la x minima e x massima e la y minima e massima 
